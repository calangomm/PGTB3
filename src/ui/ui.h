...
#define Y_AREA_JOGAVEL_FINAL (Y_AREA_JOGAVEL_INI+CARD_HEIGHT)                   //coordenada em y da area jogavel final
#define X_FINAL_BARALHO (DIST_HEADER_LEFT+CARD_WIDTH)                           //coordenada em x da area final do baralho
#define X_INICIAL_DESCARTE (X_FINAL_BARALHO+CARDS_DIST)                         //coordenada em x da area inicial do descarte
#define X_FINAL_DESCARTE (X_INICIAL_DESCARTE+CARD_WIDTH)                        //coordenada em x da area final do descarte
